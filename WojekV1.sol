...
contract OnChainNFT is ERC721Enumerable, Ownable 
{
    ...
    function mint() public payable 
    {
        ...
        //_tokens[supply + 1] = new token hash
    ...
    */
    ...
    function tokenSVG(uint256 tokenId) public view returns (string memory)
    {
        ...
        if(keccak256(abi.encodePacked(Base64.substring(tokenHash, 10 * 3, (10 * 3) + 3))) == keccak256(abi.encodePacked("1")))
        {
            //Phunked
            xScale = "-1";
        }

        string memory tokenSeries;
